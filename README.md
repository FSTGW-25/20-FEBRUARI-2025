...
<body>
  <div class="title-box">25 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 4.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Snap Shoot.mp3');
    ...
    const fullMessage = `"Hidup ini seperti hasil jepretan kamera 📸—setiap momen memiliki makna, sekecil atau sesederhana apa pun itu. Kadang gambarnya buram, kadang jelas, tapi semuanya tetap menjadi bagian dari cerita yang berharga 🌿✨ Jangan terlalu fokus pada kesalahan di masa lalu atau khawatir tentang gambar yang belum diambil, karena yang terpenting adalah bagaimana menikmati setiap detik yang terekam dalam perjalanan ini 🎞️💛 Nikmati setiap proses yang ada, dan percayalah bahwa setiap langkah yang diambil adalah bagian dari kisah luar biasa yang sedang terukir 🤍🌸🌼"`;
